...
# -*- coding: utf-8 -*-
#
# storyboard documentation build configuration file, created by
...
from storyboard.version import __version__ as STORYBOARD_VERSION
version = STORYBOARD_VERSION
# The full version, including alpha/beta/rc tags.
release = STORYBOARD_VERSION
...
htmlhelp_basename = 'storyboarddoc'
...
latex_documents = [
  (master_doc, 'storyboard.tex', 'storyboard Documentation',
   'Zhiming Wang', 'manual'),
]
...
man_pages = [
    (master_doc, 'storyboard', 'storyboard Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'storyboard', 'storyboard Documentation',
   author, 'storyboard', 'One line description of project.',
   'Miscellaneous'),
]
